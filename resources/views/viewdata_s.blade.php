            ...
            <table id="myTable{{$i}}"  class="table table-striped table-bordered results" cellspacing="0" width="100%">
              ...
              <tbody class="searchable">
                ...
                foreach($alum_intersect as $id)
                {
                  ...
                  echo '<td>'.$alum->company.'</td>';
                  echo '<td>'.$alum->designation.'</td>';
                  ...
                  echo '<td><form action="'.url('/assigntag/'.$alum['id']).'" method="post">'.csrf_field().'<select name="tag" class="form-control" id='.$alum['id'].'>';
                  ...
                  echo '<td><form action="'.url('/taggdelete/'.$alum['id']).'" method="post">'.csrf_field().'<select name="tagd" class="form-control">';
                  foreach($tags_a as $tag_a)
                  {
